...
## インストール
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_image_popuper_kai/releases/download/v1.9.4/koshian_image_popuper_kai-1.9.4-fx.xpi)  
...
## 既知の不具合
* ![\(New\)](images/new.png "New") スレ本文の表示高さが小さく表示されることがある。  
